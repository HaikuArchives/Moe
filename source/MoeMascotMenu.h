...
#ifndef MOE_MASCOT_MENU_H
#define MOE_MASCOT_MENU_H
...
class MoeMascotMenu : public BPopUpMenu
{
public:
  MoeMascotMenu(MoeMascot *target, bool advanced);

private:
  void InitItems(MoeMascot *target, bool advanced);
};
